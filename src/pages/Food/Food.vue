    ...
    <section class="sort_container">
      ...
      <div class="sort_item" :class="{ choose_type: sortBy === 'food' }">
        ...
        <transition name="showlist">
          <section
            v-show="sortBy === 'food'"
            class="food_sort_container sort_detail_type"
          >
            <ul class="food_sort_left_ul">
              <li
                class="food_sort_item"
            ...
            <ul class="food_sort_right_ul">
              <li
                class="food_details_item"
                v-for="(detailDate, index) in categoryDetail"
                @click="getCategoryIds(detailDate.id, detailDate.name)"
                :key="detailDate + index"
              >
                <span
                  class="food_menu"
                  :style="{
                    color:
                      restaurant_category_ids == detailDate.id
                        ? '#3190e8'
                        : '#666',
                  }"
                  >{{ detailDate.name }}</span
                >
            ...
            <section style="width: 100%;">
              ...
              <ul class="filter_ul">
                ...
                >
                  <!--svg-->
                  <svg
                    v-show="delivery_mode === delivery.id"
                    viewBox="0 0 38 32"
                    id="selected"
                  >
                    <path
                  ...
                  <!--text-->
                  <span
                    :class="{ selected_filter: delivery_mode === delivery.id }"
                    >{{ delivery.text }}</span
                  >
                </li>
              </ul>
                ...
                >
                  ...
                  <span
                    ...
                    :style="{
                      ...
                      'border-color': `#${activity.icon_color}`,
                    }"
                    >{{ activity.icon_name }}</span
                  >
                  <svg
                    v-show="support_ids[index].status"
                    viewBox="0 0 38 32"
