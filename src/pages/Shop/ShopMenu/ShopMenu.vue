      ...
      <section class="menu-right">
        ...
        <ul ref="foodsUl">
          ...
          <li v-for="(good, index) in goodsListMenu" :key="good + index">
            ...
            >
              <!--商铺左边的图片-->
              <router-link :to="{path: 'shopmenu/foodDetail',query:{
                geohash: geohash,
                id: shopId,
              ...
              <section class="menu_food_description">
                ...
                <h3 class="food_description_head">
                  ...
                  <div style="display: flex">
                  <span v-for="(attr, index) in food.attributes" :key="index" >
                    <p v-if="attr">
                      {{ (attr || {}).icon_name }}
                    </p>
                  </span>
       ...
       /*当菜单的数据获取到了就绑定滑动库的方法*/
        this.$nextTick(() => {
          ...
          this.foodsScroll.on("scroll", ({ x, y }) => {
            ...
            // console.log(el); // c成功
            // 改变左侧的滚动条高度
            this.scroll.scrollToElement(el, 800, 0, -(wrapperHeight / 2 - 50));
          });
