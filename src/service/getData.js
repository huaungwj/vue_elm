...
export const search_keyword = (id, keyword) =>
  axios.get(`/v1/pois`, {
    params: {
      city_id: id,
      keyword,
...
export const foodDelivery = async (latitude, longitude) =>
  axios.get(`/shopping/v1/restaurants/delivery_modes`, {
    params: {
      latitude,
      longitude,
    },
...
export const foodActivity = async (latitude, longitude) =>
  axios.get(`/shopping/v1/restaurants/activity_attributes`, {
    params: {
      latitude,
      longitude,
    },
...
export const sortShopList = async (
  latitude,
  longitude,
  offset,
  limit,
...
export const GetGoodsMenu = async (id) =>
...
/* 封装餐馆详细信息api */
export const shopDetail = async (id) =>
  axios.get(`/shopping/restaurant/${id}`, {});

/* 封装请求获取店铺评价信息 /ugc/v2/restaurants/1/ratings?offset=0&limit=10 */
export const getShowRating = async (id) =>
  axios.get(`/ugc/v2/restaurants/${id}/ratings`, {
    params: {
      offset: 0, // 跳过
      limit: 100, // 单次获取20条
    },
...
export const getRatingMenu = async (id) =>
  axios.get(`/ugc/v2/restaurants/${id}/ratings/tags`, {});

// 获取评价分数
export const getRatingScore = async (id) =>
  axios.get(`ugc/v2/restaurants/${id}/ratings/scores`, {});
